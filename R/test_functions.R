...
#' distribution of the model inputs (from \eqn{U(0, 1)} to\eqn{N(0, 1)}) is
...
budworm_diff <- function(time, state, parameters) {
...
#' The Spruce Budworm and Forest Model
#'
#' It implements the Spruce Budworm and Forest Model by \insertCite{Ludwig1976;textual}{sensobol}.
#'
#' @param y Initial conditions of the state variables.
#' @param parms Parameters and their values.
